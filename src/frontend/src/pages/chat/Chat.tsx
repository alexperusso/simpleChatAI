    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.chatRoot}>
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <h1 className={styles.chatEmptyStateTitle}>Bate-Papo RAG</h1>
                            <h2 className={styles.chatEmptyStateSubtitle}>Pergunte Algo ou use um exemplo</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Digite uma Pergunta (ex. Quem é você ?)"
                            disabled={isLoading}
                ...
                <Panel
                    headerText="Configuração de Resposta"
                ...
                >
                    <Checkbox
                        ...
                        label="Fluxo avançado (específico OpenAI) - refaz pergunta após análise, para melhor resposta"
                        onChange={onUseAdvancedFlowChange}
                    />

                    <h3>Configuração de Busca na Base de Dados:</h3>

                    <SpinButton
                        className={styles.chatSettingsSeparator}
                        label="Retorne essa quantidade de linhas:"
                        min={1}
                        max={50}
                    ...
                    <h3>Configurações de conversa:</h3>

                    <TextField
                        className={styles.chatSettingsSeparator}
                        defaultValue={promptTemplate}
                        label="Sobrescrever template de prompt"
                        multiline
                        autoAdjustHeight
                    ...
                    <Checkbox
                        ...
                        label="Completar resposta com stream de dados"
